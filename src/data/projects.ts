...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Govt Girls School 2 (PEIMA) — گورنمنٹ گرلز سکول 2 ملکہ ہانس',
    school: 'Govt Girls School 2 (PEIMA) Malka Hans',
    urduTitle: 'گورنمنٹ گرلز سکول 2 ملکہ ہانس (پیما)',
    ...
    status: 'completed',
    description:
      'Under Punjab Education Initiatives Management Authority (PEIMA, EMIS: 39210569), providing pure RO drinking water to female students and faculty at Government Girls School 2, Malka Hans.',
    longDescription:
      'Operating under the Punjab Education Initiatives Management Authority (PEIMA, School EMIS Code: 39210569), Government Girls School 2 Malka Hans (گورنمنٹ گرلز سکول 2 ملکہ ہانس) provides quality education to young girls in the historic rural belt of Pakpattan District. Untreated groundwater with high TDS and microbial contamination previously caused recurring health concerns and absenteeism among students. Iris Foundation installed a dedicated commercial Reverse Osmosis (RO) water purification plant with multi-tier pre-filtration, semi-permeable membranes, and child-safe dispensing taps. Today, students and dedicated faculty enjoy pure, tested, and chilled drinking water every single day.',
    studentsReached: '1,200+',
    date: '2024',
    image: '/projects/govt-girls-peima-4.jpeg',
    videoUrl: '/projects/govt-girls-malka-video.mp4',
    gallery: [
      '/projects/govt-girls-peima-4.jpeg',
      '/projects/govt-girls-peima-3.jpeg',
      '/projects/govt-girls-peima-1.jpeg',
      '/projects/govt-girls-peima-2.jpeg',
      '/projects/govt-girls-peima-5.jpeg',
    ],
    impact: [
      'Daily access to certified pure RO water for 1,200+ students and teachers under PEIMA',
      'Dramatic drop in gastrointestinal infections and seasonal attendance disruptions',
      'High-capacity multi-membrane industrial filtration system with TDS monitoring',
      'Child-safe dispensing fountains encouraging healthy, all-day hydration for girls',
    ],
